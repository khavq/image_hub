defmodule ImageHubWeb.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule ImageHub.MyChannel do
        use ImageHubWeb, :channel
        alias ImageHubWeb.Presence
  ...
  """
  use Phoenix.Presence, otp_app: :image_hub,
                        pubsub_server: ImageHub.PubSub
end
